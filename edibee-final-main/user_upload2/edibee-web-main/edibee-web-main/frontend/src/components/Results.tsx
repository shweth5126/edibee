...
const stats = [
  { value: 100, suffix: "M+", label: "Views", sub: "Across Platforms" },
  { value: 500, suffix: "+", label: "Projects", sub: "Film • Photo • Brand" },
  { value: 50, suffix: "+", label: "Brands", sub: "Seed to Scale" },
];
...
export function Results() {
  return (
    <section className="relative overflow-hidden bg-offwhite px-6 py-12 md:px-10 md:py-16">
      <div
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <Reveal className="flex flex-col items-center text-center">
          ...
          <h2
            ...
            style={{ fontSize: "clamp(2rem, 4vw, 3.6rem)", marginTop: "12px" }}
          >
            Attention you can
            <span className="text-honey">.</span>
          </h2>
          <p
            className="max-w-2xl text-sm leading-6 text-charcoal/70 md:text-base"
...
>                      initial={{ opacity: 0, y: 16 }}
                    ...
                    >
                      ...
                      {/* Title */}
<p className="mt-6 font-display text-lg font-medium tracking-tight text-ink">                        {stat.label}
                      </p>

                      {/* Description */}
<p className="mt-1 text-sm text-charcoal/55">                        {stat.sub}
                      </p>
                    </motion.div>
                  </div>
                ))}
              ...
              {/* And Counting - Moved directly below, minimal spacing */}
            </div>
          </div>
        </Reveal>
      </div>
